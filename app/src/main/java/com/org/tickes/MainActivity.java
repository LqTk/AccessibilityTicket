...
public class MainActivity extends AppCompatActivity {
    ...
    private void refreshLayout() {
        ...
        tvServiceStatue.setText(isOn ? "服务已启动" : "服务未启动");
        tvServiceStatue.setTextColor(isOn ? Color.BLUE : Color.RED);
        ...
        if (PackageUtils.isAppInstalled(context, Global.flyPig)) {
            tvOpenFlypig.setVisibility(View.VISIBLE);
        } else {
            tvOpenFlypig.setVisibility(View.GONE);
        }

    }

    @OnClick({R.id.tv_start_service, R.id.tv_open_flypig, R.id.ll_addinfo, R.id.ll_addperson})
